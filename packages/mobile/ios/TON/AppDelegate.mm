...
- (NSURL *)tonURLByDisablingLazyBundleLoading:(NSURL *)url
{
  if (!url) {
    return nil;
  }
...
{
  if ([identifier isEqualToString:[TONIosBackgroundDownloadsManager backgroundSessionIdentifier]]) {
    [[TONIosBackgroundDownloadsManager sharedManager] setBackgroundSessionCompletionHandler:completionHandler];
    return;
  }
